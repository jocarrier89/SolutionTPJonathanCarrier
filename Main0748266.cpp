...
#include "Menus0748266.h"		// Bibliothèque du programmeur rassemblant les fonctions permettant la gestion des menus et la validation des choix fait dans ces menus
#include "Formes0748266.h"	// Bibliothèque du programmeur offrant des fonctions permettant de dessiner différentes formes, pleines ou vides
#include <ctime>            // Ajoute la bibliothèque du temps
#include "Labo06Fonctions.h" // ajoute la fonction saisirEntier() qui débug le clavier
			...
			{	
               ...
               break;
				...
				case LOSANGE :
					...
					break;
				case ISOCELE:
					traiterIsocele(choixRemplissage);
			} // Fin du switch
	   }// fin du if
